...
module.exports = {
    ...
    async execute(interaction) {
        const logChannelId = '1274438972650815723'; // Log channel ID
        ...
        try {
            ...
            if (interaction.isStringSelectMenu()) {
                if (interaction.customId === 'ticket_select') {
                    ...
                    const generalStaffRoleId = '1273703788993319046'; 
                    const staffReportRoleId = '1273700260283416619'; 
                    ...
                    const categoryID = '1274791037495152773'; 
            ...
            // Handle Buttons
                ...
                if (interaction.customId === 'claim_ticket') {
                    const staffRoleId = '1273703788993319046'; 
                    const staffReportRoleId = '1273699191671226481'; 
                ...
                if (interaction.customId === 'reopen_ticket') {
                    const staffReportRoleId = '1262482937811828838';
                    const generalStaffRoleId = '1259165877807616134';
                ...
                if (interaction.customId === 'close_ticket_final') {
                    ...
                    const finalCloseEmbed = new EmbedBuilder()
                        .setTitle('RRS | Ticket Permanently Closed')
